...
//    cout << this_thread::get_id() << " got shared freeing_lock: " << res << ". Sleeping" << endl;
//    this_thread::sleep_for(std::chrono::milliseconds(2000));
//    cout << this_thread::get_id() << " awake. Releasing freeing_lock" << endl;
//    my_lock.unlock_shared();
//}
//
//void take_lock_shared() {
//    bool res = my_lock.try_lock_shared();
//    cout << this_thread::get_id() << " got shared freeing_lock: " << res << endl;
//    cout << this_thread::get_id() << " Releasing freeing_lock" << endl;
//    my_lock.unlock_shared();
//}
//
//void take_lock_unique_and_sleep() {
//    while (!my_lock.try_lock()){}
//    cout << this_thread::get_id() << " got unique freeing_lock" << endl;
//    this_thread::sleep_for(std::chrono::milliseconds(2000));
